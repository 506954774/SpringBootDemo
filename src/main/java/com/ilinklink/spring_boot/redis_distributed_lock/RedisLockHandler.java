...
@Aspect
@Slf4j
public class RedisLockHandler implements ApplicationContextAware {
    ...
    public Object redisLock(ProceedingJoinPoint jp, RedisLock redisDistributedLock) throws Exception{
